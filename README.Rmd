...
```{r ex01, warning=FALSE, message=FALSE}
# Loads the package
library(carnaval)
...
This package was created by [Ícaro Bernardes](https://twitter.com/IcaroBSC).

The hex logo was created by [Bruno Mioto](https://twitter.com/BrunoHMioto). Bruno also gave many tips that made building the package easier.
